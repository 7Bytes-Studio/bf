...
namespace bf
{
    public sealed partial class Utility
    {
        ...
        public static class Project
        {
            ...
            /// 检查或创建项目目录。
            /// </summary>
            public static void CheckOrCreateProjectFolder_Windows(string projectName,string projectType,string d = "d")
            {
                ...
                BlackFire.Utility.IO.ExistsOrCreateFolder(projectRoot+".Unity/Assets/Plugins/Framework/BasicFramework");
                BlackFire.Utility.IO.ExistsOrCreateFolder(projectRoot+".Unity/Assets/Plugins/Framework/BusinessFramework");
            }
        }
    }
}